            ...
            <div class="d-inline-block align-items-center">
                <nav>
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Create Service Form</li>
                    </ol>
                </nav>
            </div>
        </div>
...
<section class="content row justify-content-center align-items-center">
    <div class="box box-default">
        <div class="box-header with-border">
          <h4 class="box-title">New Service Details</h4>
        </div>
        <!-- /.box-header -->
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="number" name="fee" class="form-control" id="emailAddress1" value="{{ old('fee') }}" required>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea name="description" class="form-control" id="phoneNumber1" value="{{ old('description') }}" required cols="10" rows="2"></textarea>
                            </div>
                        </div>
                    </div>
