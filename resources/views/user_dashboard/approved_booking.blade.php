...
<div class="content-header">
    <div class="d-flex align-items-center">
        <div class="mr-auto">
            <h3 class="page-title">Bookings Table</h3>
        ...
        <div class="box">
          ...
          <div class="box-body no-padding">
              <div class="table-responsive">
                @if(!empty($approvedBookings) && $approvedBookings->count())
                <table class="table table-hover">
                  <tr>
                    ...
                    <tr>
                        ...
                        <td>{{ $approvedBookingsFees[$task->id]}}</td>
                        <td>
                ...
                @else
                    <h4 style="text-align: center">No Approved bookings Exists</h4>
                @endif
              </div>
          </div>
          <!-- /.box-body -->
