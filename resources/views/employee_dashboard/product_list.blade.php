...
@section('content')
    <div class="content-header">
        <div class="d-flex align-items-center">
            ...
            <a class="btn btn-rounded btn-primary float-right" href="{{ route('employee.product.create') }}">
                Add Product
            </a>
        </div>
    </div>
                                    ...
                                    @foreach ($deactiveProducts as $product)
                                        <tr>
                                            ...
                                            <td><span class="text-muted"><i
                                                        class="fa fa-clock-o"></i>{{ $product->status }}</span> </td>
                                            @if ($product->image != null)
                                                <td><img style="height: 40px; width: 45px; border-radius: 50%"
                                                        src="{{ $product->image }}" alt="null"></td>
                                            @else
                                                <td><img style="height: 40px; width: 45px; border-radius: 50%"
                                            ...
                                            <td>
                                                <a class="btn btn-rounded btn-primary"
                                                    href="{{ route('employee.product.show', ['id' => $product->id]) }}">
